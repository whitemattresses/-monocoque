...
const typologiesPage: LocalizedDictionary["typologiesPage"] = {
  ...
  walkthrough: {
    exploreInterior: "Εξερευνήστε το Εσωτερικό",
    instructions: "Κάντε κλικ για είσοδο — WASD για κίνηση — Ποντίκι για περιήγηση — ESC για έξοδο",
    controlsHint: "WASD — Κίνηση  /  Ποντίκι — Θέα  /  ESC — Έξοδος",
    unsupported: "Παρακαλούμε χρησιμοποιήστε browser υπολογιστή για την εμπειρία 3D",
  },
  cta: {
